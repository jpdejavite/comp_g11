...
public final class AFalseExp extends PExp
{
    ...
    public AFalseExp(
        @SuppressWarnings("hiding") TTokFalse _token_)
    {
        // Constructor
        setToken(_token_);
    ...
    public TTokFalse getToken()
    {
        return this._token_;
    }

    public void setToken(TTokFalse node)
    {
