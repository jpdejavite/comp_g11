...
public final class AArrayLookupExp extends PExp
{
    ...
    public AArrayLookupExp(
        ...
        @SuppressWarnings("hiding") TTokLbracket _token_)
    {
        // Constructor
        setArray(_array_);
    ...
    public TTokLbracket getToken()
    {
        return this._token_;
    }

    public void setToken(TTokLbracket node)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setToken((TTokLbracket) newChild);
            return;
        }
