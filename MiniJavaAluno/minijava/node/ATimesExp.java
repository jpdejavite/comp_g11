...
public final class ATimesExp extends PExp
{
    ...
    public ATimesExp(
        ...
        @SuppressWarnings("hiding") TTokTimes _token_)
    {
        // Constructor
        setLhs(_lhs_);
    ...
    public TTokTimes getToken()
    {
        return this._token_;
    }

    public void setToken(TTokTimes node)
    {
