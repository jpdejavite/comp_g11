...
public final class AArrayType extends PType
{
    ...
    public AArrayType(
        @SuppressWarnings("hiding") TTokIntarray _token_)
    {
        // Constructor
        setToken(_token_);
    ...
    public TTokIntarray getToken()
    {
        return this._token_;
    }

    public void setToken(TTokIntarray node)
    {
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        {
            setToken((TTokIntarray) newChild);
            return;
        }
